...
CREATE TABLE `AwardsShareManagers` (
  ...
  foreign key(`playerID`,`awardID`, `yearID`) references AwardsManagers(`playerID`,`awardID`, `yearID`)
...
CREATE TABLE `AwardsSharePlayers` (
  ...
  foreign key(`playerID`,`awardID`, `yearID`,`lgID`) references AwardsPlayers(`playerID`,`awardID`, `yearID`,`lgID`)
...
CREATE TABLE `HomeGames` (
  ...
  foreign key(`year.key`,`league.key`,`team.key`) references Teams(`yearID`,`lgID`,`teamID`)
...
CREATE TABLE `ManagersHalf` (
  ...
  `L` int DEFAULT NULL,
  `rank` int DEFAULT NULL,
  primary key(`playerID`,`Half`),
  foreign key(`playerID`,`yearID`,`inseason`) references Managers(`playerID`,`yearID`,`inseason`)
...
CREATE TABLE `Salaries` (
  ...
  primary key(`teamID`,`yearID`,`playerID`),
  foreign key(`playerID`) references Master(`playerID`)
...
CREATE TABLE `SeriesPost` (
  ...
  foreign key(`yearID`,`lgIDwinner`,`teamIDwinner`) references Teams(`yearID`,`lgID`,`teamID`),
  foreign key(`yearID`, `lgIDloser`,`teamIDloser`) references Teams(`yearID`,`lgID`,`teamID`)
