...
USE BASEBALL;
CREATE INDEX PLAYERID on HALLOFFAME(playerID);
CREATE INDEX PLAYERID on Master(playerID);
...
ALTER TABLE HALLOFFAME DROP INDEX PLAYERID;
ALTER TABLE Master DROP INDEX PLAYERID;
-- 3)
...
SHOW INDEXES IN Master;
CREATE INDEX PLAYERID on Salaries(playerID);
SHOW INDEXES IN Salaries;
...
ALTER TABLE Salaries DROP INDEX PLAYERID;
ALTER TABLE Master DROP INDEX PLAYERID;
...
USE BASEBALL;
CREATE INDEX PLAYERID on Salaries(playerID);
CREATE INDEX PLAYERID on Managers(playerID);
CREATE INDEX PLAYERID on Master(playerID);
...
ALTER TABLE Salaries DROP INDEX PLAYERID;
ALTER TABLE Managers DROP INDEX PLAYERID;
ALTER TABLE Master DROP INDEX PLAYERID;
